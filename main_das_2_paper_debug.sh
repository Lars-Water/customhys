...
CONFIG_PATH_COORDINATOR="${BASE_PATH}/config/experiment_asml_debug/config_coordinator_experiment_debug.json"
...
source setenv
cd ${BASE_PATH}
CONFIG_PATH_EXPERIMENT="${BASE_PATH}/config/experiment_asml_debug/experiment_asml_debug.json"
