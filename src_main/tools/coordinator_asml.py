...
class HeuristicSimulationCoordinatorASML(HeuristicSimulationCoordinator):
    ...
    def __init__(self, base_path, coordinator_config_file_path, nr_of_agents, run_name=None, nr_of_design_queues=0):
        ...
        self.data_collector = DataCollectorASML(weight_wfpm, dir_design_points_metrics_output)
    ...
    def generate_design_point(self, sim_id, agent_configuration):
        ...
        self.duplicate_directory(self.simulation_model_template_path, design_point_path, "platform.xml")
    ...
    def obtain_simulation_stats(self, uids):
        ...
        for sim_uid, agent_id in uids.items():
            ...
            if self.store_design_points_metrics_values:
                ...
                self.data_collector.store_design_point_metrics(wfpm, sim_uid, self._run_name)
    ...
    def get_boundaries(self):
        ...
        return self.min_wfpm_runtime, self.max_wfpm_runtime
