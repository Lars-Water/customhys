...
class HeuristicSimulationCoordinator:
    ...
    def simulation_run(self, fitfunc, config_values):
        ...
        if self.nr_of_agents > 1:
            ...
            # sim_instances = self.run_multiple_simulation_configuration()

            # # Transform the outputted scalar files into csv format.
            # self.transform_scalar_files(sim_instances)
    ...
    # '''
    # def transform_scalar_files(self, sim_instances):
    #     pass
    ...
    def obtain_simulation_stats(self, uids):
        ...
        for sim_uid, agent_id in uids.items():
            ...
            # TODO: REMOVE CSV FILES AGAIN.
            self.logger.warn("CSV file not being removed")
            # # Remove the csv file.
