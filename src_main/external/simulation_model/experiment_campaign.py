...
from experiments import create_sim_custom_dummy, create_tictoc, create_sim_inet_lans_dummy
...
# -------------------------------------------------------------------------------------------
    ...
    elif args.model == "custom_lans":
        num_sims = args.num_sims
        sim_instances = [create_sim_inet_lans_dummy(config, dummy_sim_path, id, inet_base) for id in range(num_sims)]
# -------------------------------------------------------------------------------------------
    else:
        sim_instances = []
    ...
    return evaluated_sim_instances[0].uid
