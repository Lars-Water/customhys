...
class Metaheuristic:
    ...
    def __init__(self, problem, search_operators=None, num_agents: int = 30, num_iterations: int = 100,
        ...
        # Create population
        self.pop = Population(problem, num_agents, finalised_positions_previous_step=finalised_positions_previous_step, pass_finalised_positions=pass_finalised_positions, logger=self.logger)
    ...
    def run(self, hh_step=None, file_label=None):
        ...
        :return: None.
        """
        self.logger.debug(f"Metaheuristic run started for hh_step: {hh_step} and file_label: {file_label}")
