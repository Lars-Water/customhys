...
class Population:
    ...
    # ------------------------------------------------------------------------
    def __init__(self, problem, num_agents=30, finalised_positions_previous_step=None, pass_finalised_positions = False, logger=None):
        """
        ...
        if logger is not None:
            ...
            self.logger = loggerRICH("Population")
        ...
        self.first_fitness_evaluation = True
    ...
    def evaluate_fitness(self, problem_function, fitness_values=None):
        """
