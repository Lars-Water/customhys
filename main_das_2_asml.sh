...
CONFIG_PATH_COORDINATOR="${BASE_PATH}/config/coordinator/config_coordinator_das_2_asml.json"
...
# Experiment 1.
CONFIG_PATH_EXPERIMENT_1="${BASE_PATH}/config/experiment_asml/experiment_asml.json"
# python3 main.py \
#  --experiment 1 \
#  --nr_sw 50 \
#  --base_path "$BASE_PATH" \
