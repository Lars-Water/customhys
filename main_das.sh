...
BASE_DIR="/home/lvdwater/hyper-heuristic-dse-2.0"
...
python3 main.py --base_dir "$BASE_DIR" --heur_run_config "$CONFIG_PATH_HEUR_RUN" --coordinator_config "$CONFIG_PATH_COORDINATOR"
