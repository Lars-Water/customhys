...
class HeuristicSimulationCoordinator:
    ...
    def __init__(self, config_path):
        ...
        # Set up the logger.
        self.logger = ("coordinator", "/workspaces/hyper-heuristic-dse-2.0/data/raw/heuristic_run/logs")

        # Read the config file.
        self.logger.info("Reading config file...")
        self.conf = Config("/workspaces/hyper-heuristic-dse-2.0/config/coordinator.json", "/workspaces/hyper-heuristic-dse-2.0/data/raw/heuristic_run/logs", "config_coordinator")
    ...
    def transform_scalar_files(self):
        ...
        self.logger.info("Transforming scalar files to csv in directory: " + sim_results_directory)
        try:
    ...
    def obtain_simulation_stats(self):
        ...
        uid = "343ddead4455987aae4c6e56e3cb132a"
        csv_file_path = self.conf.tryGet(os.path.join("results_base", uid, "x.csv"))
