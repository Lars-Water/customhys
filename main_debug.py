...
def experiment_asml(base_path, coordinator_config_file_path):
    ...
    experiment_1_config_file_path = Path(os.path.join(base_path, "config/experiment_asml_debug/experiment_asml_debug.json"))
    experiment_1_log_path = os.path.join(log_path, "experiments/experiment_asml_debug")
